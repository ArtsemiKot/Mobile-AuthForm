...
export default function Reg({ navigation }) {
    ...
    return (
        <View style={styles.wrapper}>
            ...
            <Text style={styles.textAlready}>Already have an account ? <Text onPress={() => navigation.navigate('Auth')}>Sign In</Text></Text>
            <Text style={styles.textAgree} onPress={checkInp}>Agree and continue</Text>
        </View >
    );
}